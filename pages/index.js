		...
		return <div>
		    ...
		    <Body>
		    	<Div>
			    	...
			    	<Div css={frameCSS} width={1} height={this.state.view == 'split' ? ['34vh','20vh'] : ['20vh','20vh']} textAlign="center" position="relative" zIndex="999" bg="white">
			    		<H1 px={3} pt={[this.state.view == 'split' ? '4vh' : '3vh','2.5vh','2.5vh','4vh']} fontSize={[this.state.view == 'split' ? '6vh' : '4vh','6vh','7vh','8vh']} color="blue" lineHeight="1">
			    			<Span display={['block','inline']}>CSS-in-JS</Span> 
			    			<Span display={['block','inline-block']} px={[0,2,3]} fontSize={[this.state.view == 'split' ? '4vh' : '2vh','3vh','4vh']} position="relative" top={[0,'-1.2vh','-1.5vh']}> or </Span> 
			    			<Span display={['block','inline']}>CSS-and-JS</Span>
			    		</H1>
		    			<H2 pt={['1vh',0]} fontSize={this.state.view == 'split' ? ['2.5vh','2.5vh','2.5vh','3vh'] : '2vh'} fontWeight={[400,400,400,200]} color="gray9">( Can we all just get along? )</H2>
			    		<Button display={this.state.view == 'split' ? 'inline-block' : ['none','inline-block']} fontSize={0} is="a" bg="rgba(0,0,0,.33)" color="white" href="https://github.com/johnpolacek/css-in-js-or-css-and-js/" target="_blank" position={['static','static','static','absolute']} top="0" right="0" mt={[3,2,2,'50px']} mr={[0,4]}>View on Github</Button>
			    	</Div>
